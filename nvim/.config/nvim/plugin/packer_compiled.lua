...
_G.packer_plugins = {
  ...
  ["nvim-docs-view"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/root/.local/share/nvim/site/pack/packer/opt/nvim-docs-view",
    url = "https://github.com/amrbashir/nvim-docs-view"
  },
  ["nvim-highlight-colors"] = {
    config = { "\27LJ\2\nG\0\0\3\0\3\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0004\2\0\0B\0\2\1K\0\1\0\nsetup\26nvim-highlight-colors\frequire\0" },
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-highlight-colors",
  ...
  ["supermaven-nvim"] = {
    ...
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/supermaven-nvim",
